(ns marketentry.marketentryllm
  ...
  the Central African Republic (CAF) public-sector market-entry
  compliance actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "reserved-market?=" (:reserved-market? e)
                        " social-economy-legal-form=" (:social-economy-legal-form e)
                        " pct-disabled-employees=" (:pct-disabled-employees e)
                        " pct-youth-employees=" (:pct-youth-employees e)
                        " pct-women-employees=" (:pct-women-employees e)
                        " dgid-record-verified?=" (:dgid-record-verified? e)
     ...
     :confidence (if (and e
                          (or (not (:requires-dgid-record? e))
                              (:dgid-record-verified? e)))
                   0.9 0.3)}))
