(ns marketentry.store
  "SSoT for the Central African Republic (CAF) market-entry compliance
...
(defn demo-data
  ...
  `:reserved-market?` / `:social-economy-legal-form` /
  `:pct-disabled-employees` / `:pct-youth-employees` /
  `:pct-women-employees` are ground truth for the
  `reserved-market-ineligible` flagship check (Code de la Commande
  Publique, Chapitre II, 'Marché réservé'); `:requires-dgid-record?` /
  `:dgid-record-verified?` are ground truth for the conditional DGID
  tax-record check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Bangui Fabrication SARL" :portal "finances.gouv.cf/marches-publics"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :reserved-market? false :social-economy-legal-form nil
             :pct-disabled-employees 0.0 :pct-youth-employees 0.0 :pct-women-employees 0.0
             :requires-dgid-record? true :dgid-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "CAF" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "finances.gouv.cf/marches-publics"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :reserved-market? false :social-economy-legal-form nil
             :pct-disabled-employees 0.0 :pct-youth-employees 0.0 :pct-women-employees 0.0
    ...
    "eng-3" {:id "eng-3" :operator "Oubangui Systems SA" :portal "finances.gouv.cf/marches-publics"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "CAF" :status :intake}
    "eng-4" {:id "eng-4" :operator "Bimbo Artisanat Coopérative" :portal "finances.gouv.cf/marches-publics"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :reserved-market? true :social-economy-legal-form nil
             :pct-disabled-employees 0.05 :pct-youth-employees 0.10 :pct-women-employees 0.20
             :requires-dgid-record? true :dgid-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "CAF" :status :intake}
    "eng-5" {:id "eng-5" :operator "Berberati Logistics SARL" :portal "finances.gouv.cf/marches-publics"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :reserved-market? false :social-economy-legal-form nil
             :pct-disabled-employees 0.0 :pct-youth-employees 0.0 :pct-women-employees 0.0
             :requires-dgid-record? true :dgid-record-verified? false
             :drafted? false :submitted? false
             :jurisdiction "CAF" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               ...
                               requires-dgid-record? dgid-record-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? reserved-market?)              (assoc :engagement/reserved-market? reserved-market?)
    social-economy-legal-form             (assoc :engagement/social-economy-legal-form social-economy-legal-form)
    (some? pct-disabled-employees)        (assoc :engagement/pct-disabled-employees pct-disabled-employees)
    (some? pct-youth-employees)           (assoc :engagement/pct-youth-employees pct-youth-employees)
    (some? pct-women-employees)           (assoc :engagement/pct-women-employees pct-women-employees)
    (some? requires-dgid-record?)         (assoc :engagement/requires-dgid-record? requires-dgid-record?)
    (some? dgid-record-verified?)         (assoc :engagement/dgid-record-verified? dgid-record-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/reserved-market? :engagement/social-economy-legal-form
   :engagement/pct-disabled-employees :engagement/pct-youth-employees :engagement/pct-women-employees
   :engagement/requires-dgid-record? :engagement/dgid-record-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :reserved-market? (boolean (:engagement/reserved-market? m))
     :social-economy-legal-form (:engagement/social-economy-legal-form m)
     :pct-disabled-employees (:engagement/pct-disabled-employees m)
     :pct-youth-employees (:engagement/pct-youth-employees m)
     :pct-women-employees (:engagement/pct-women-employees m)
     :requires-dgid-record? (boolean (:engagement/requires-dgid-record? m))
     :dgid-record-verified? (boolean (:engagement/dgid-record-verified? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-caf"})
